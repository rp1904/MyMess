...
public class UserServicesImpl implements UserServices {
  ...
  public User saveUser(User user) {
    ...
    user.getUserProfile().setFullName(
    ...
    String msgBody = EmailTemplates
        .createLoginCredentialsMessage(user.getUserProfile().getFullName(), user.getEmail(), pass);
  ...
  @Override
  public List<User> getMembersByMessAndSearch(String searchString, Mess mess, int start,
      int limit) {
    // TODO Auto-generated method stub
