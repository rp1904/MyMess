...
public class UserServicesImpl implements UserServices {
	...
	public User saveUser(User user) {
		...
		user.getUserProfile()
				.setFullName(user.getUserProfile().getFirstName() + " " + user.getUserProfile().getLastName());
		...
		String msgBody = EmailTemplates.createLoginCredentialsMessage(user.getUserProfile().getFullName(),
				user.getEmail(), pass);
