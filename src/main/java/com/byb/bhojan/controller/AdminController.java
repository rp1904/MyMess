...
public class AdminController {
  ...
  public ModelAndView adminHomePage() {
    ...
    SimpleGrantedAuthority grantedAuthority = (SimpleGrantedAuthority) (SecurityContextHolder
        .getContext().getAuthentication().getAuthorities()).toArray()[0];
  ...
  @RequestMapping(value = "/mess/list", produces = MediaType.APPLICATION_JSON_VALUE,
  ...
  @SuppressWarnings("unchecked")
  @RequestMapping(value = "/mess-members/list", produces = MediaType.APPLICATION_JSON_VALUE,
      method = RequestMethod.GET)
