...
public class MessMembersController extends BaseController {
  ...
  public ResponseEntity<?> registerMember(@RequestBody User member) {
    ...
    memberMealCoupenHistoryServices.saveMemberMealCoupen(savedMember.getUserIdPk(),
        mealCoupen.getCoupenId());
  ...
  public ResponseEntity<List<User>> gerMembersWithSearchString(
      @PathVariable("searchString") String searchString, @PathVariable("start") int start,
      @PathVariable("limit") int limit) {
