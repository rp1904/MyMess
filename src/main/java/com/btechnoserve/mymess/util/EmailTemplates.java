...
public class EmailTemplates {
	...
	public static String startDefualtMessage = "<html> " + "<head>" 
			...
			+ "<div style='margin:0px;padding:0px;float:left;width:639px;background-color:#FF6501;'>" 
			...
			+ "<h1>T-Driver</h1></div>" + "<div style='padding:0px;margin:0px;float:left;width:15px;min-height:63px'>" 
			+ "</div>" + "</div>"
	...
	public static String endDefualtMessageTemplete = "</div><div style='border-bottom:2px dotted #c8c8c8;padding:20px 19px 20px;font-family:arial;font-size:14px;'>" 
			...
			+ "If you need any help or have feedback about T-Driver, please email us at</p>" 
			+ "<a style='color:#0084ff;text-decoration:none;font-size:16px;font-family:arial" +

			"href='#13e21ab5a6f40253_13d34c9c6b6e685a_'>support@t-driver.com</a>" + "<p>Warm wishes, <br>" 
			+ "The T-Driver Team</p>" + "</div>" + "</div>" 
			+ "<div style='margin:0px;padding:0px;float:left;width:639px;background-color:#FF6501;'>"
			+ "<div style='padding:0px;float:left;width:15px;min-height:63px'> </div>" 
			...
			+ "You are receiving this email because you are registered for a T-Driver account.<br>" 
			+ "&copy; 2016 Copyright T-Driver. All rights reserved.</p>" + "</div>" 
	...
	public static String createLoginCredentialsMessage(String fullUserName, String username, String password) {
		...
		String message = startDefualtMessage 
						...
						+ ",</h1>" 
						+ " <p>Thank you for using <strong>T-Driver</strong>.<br/><br/> " 
	...
	public static String createFacebookLoginMessageTemplate() {
		...
		String message = startDefualtMessage 
						...
						+ ",</h1>" 
						+ " <p>Thank you for using <strong>T-Driver</strong>.<br/><br/> " 
						+ " Now you can login with T-Driver using your facebook account.<br><br>"
						+ " </p>" 
						+ endDefualtMessageTemplete;
		//@formatter:on
		return message;
	...
	public static String getDefaultForgotPasswordMessage(String fullUserName, String username, String password) throws IOException {
		...
		String message = startDefualtMessage 
						+ " <h1>Dear "+fullUserName  
						+ ",</h1>" 
						+ " <p>You told us you forgot your password.<br><br>" 
	...
	public static String createSendReferralMessage(String userFullName, String messageBody) {
		...
		String message = startDefualtMessage 
						//+ " <h1>Dear User" 
						//+ "</h1>" 
//						+ " <p>You have been invited by <strong>"+userFullName+"</strong> to <strong>T-Driver</strong> app.<br/><br/> " 
						+ " <p>"+messageBody 
						+ " </p>" 
						+ endDefualtMessageTemplete;
		//@formatter:on
	...
	public static String getPasswordMailTemplate(HttpServletRequest req, String tempPassword) {
		...
		//@formatter:off
		PASSWORD_MAIL_TEMPLETE = "<!DOCTYPE html>"
				+ "<html lang='en-US'>"
					+ "<head>"
						+ "<meta charset='utf-8'>"
									...
									+ "<table  style='width: 100%;' cellpadding='0' cellspacing='0'>"
										+ " <tr>"
											+ "<td style='text-align: left;padding: 25px 50px; border-bottom: 1px solid #ebebeb; background-color: #fff;'>"
												+ "<img src='"+ProjectConstant.BASE_URL+"/resources/assets/images/' style='max-width: 195px; width: 100%;'/>"
											+ "</td>"
										+ "</tr>"
									+ "</table>"
								+ "</td></tr>"
										...
										+ "<table>"
											+ "<tr>"
												+ "<td style='padding: 10px 0;font-size: 18px;color: #434850;font-weight: bold;line-height: 28px;'>"
													+ "You told us you forgot your password. Your temporary password is :"+tempPassword
												+ "</td>"
											+ "</tr>"
	...
	public static String getWelcomeMailTemplate(String password) {
		...
		//@formatter:off
		WELCOME_MAIL_TEMPLETE = "<!DOCTYPE html>"
				+ "<html lang='en-US'>"
					+ "<head>"
						+ "<meta charset='utf-8'>"
						+ "<meta name='viewport' content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0' />"
					...
					+ "<body style=' color: #000; font-size: 17px; font-family: arial;'>"
						...
						+ "<table  style='width: 100%;' cellpadding='0' cellspacing='0'>"
							+ "<tr>"
								+ "<td style='font-size: 20px;color: #434850;font-weight: bold;line-height: 50px;'>"
									+ "Welcome to T-Driver, Your Account is Active<br/>"
									+ "<span style='color: #2ab27b;'>Welcome to T-Driver!</span>"
								+ "</td>"
							+ "</tr>"
							+ "<tr>"
								+ "<td style='font-size: 15px;color: #434850;vertical-align: top;line-height: 28px;padding-top: 20px;'>"
									+ "Your <strong>account is now active</strong> and ready to use!"
								+ "</td>"
							+ "</tr>";
							...
							+ "<tr>"
								+ "<td style='font-size: 15px;color: #434850;vertical-align: top;line-height: 28px;padding-top: 20px;'>"
									...
									+ "Take a moment to download our App and start your first transaction."
								+ "</td>"
							+ "</tr>"
							+ "<tr>"
							...
							+ "<tr>"
								+ "<td style='font-size: 13px;color: #aaaaaa;vertical-align: top;line-height: 10px;text-align: center;'>"
									+ "T-Driver is always free for an unlimited period of time and unlimited number of people"
								+ "</td>"
							+ "</tr>"
							+ "<tr>"
								+ "<td style='font-size: 15px;color: #434850;vertical-align: top;line-height: 44px;padding-top: 10px;'>"
									+ "Good luck with T-Driver!<br/>"
									+ "-- T-Driver! Team"
								+ "</td>"
							+ "</tr>"
						+ "</table>"
